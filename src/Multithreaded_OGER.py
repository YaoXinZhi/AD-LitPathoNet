...
def oger_result_process(split_file: str, save_path: str, process_id: str):

    base_name = os.path.basename(split_file)

    save_file = f'{save_path}/{base_name}'

    with open(split_file) as f, open(save_file) as wf:
        pass


    with open(save_file) as wf:
        pass
